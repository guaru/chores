...
module.exports = " <!-- Page Heading -->\r\n <div class=\"d-sm-flex align-items-center justify-content-between mb-4\" *ngIf=\"tablero.id != null && tablero.id != 0\">\r\n        <h1 class=\"h3 mb-0 text-gray-800 w-75\">\r\n              <input type=\"text\" class=\"form-control input-title-edit\" [(ngModel)]=\"tablero.name\" (change)=\"onChangeTablero()\" >      \r\n        </h1>\r\n        <a href=\"#\" class=\"d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm\"><i class=\"fas fa-download fa-sm text-white-50\"></i> Generate Report</a>\r\n</div>\r\n\r\n<app-status *ngIf=\"tablero.id != null && tablero.id != 0\" [tablero]=\"tablero\" [users]=\"users\" [status]=\"status\"  ></app-status>"
